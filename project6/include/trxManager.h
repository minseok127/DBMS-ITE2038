...
#define TRX_MANAGER_HASH_SIZE (1000)
...
public:
    ...
    void store_original_log(trxNode* targetTrx, int table_id, int64_t key, uint64_t pagenum, char* redo, char* undo);
    ...
    void set_next_trx_id(int trx_id);
};
